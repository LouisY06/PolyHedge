...
import { LogOut, TrendingUp, TrendingDown, Package, Shield, BarChart3, RefreshCw, Loader2 } from 'lucide-react'
      ...
      <header className="bg-white/80 backdrop-blur-xl border-b border-black/5 sticky top-0 z-50">
        <div className="max-w-[1200px] mx-auto px-5 h-[60px] flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-text-primary font-extrabold text-[18px] tracking-tight font-heading">
      ...
      <main className="max-w-[1200px] mx-auto px-5 py-6">
          ...
          <div className="hero-card p-7 mb-7 animate-fade-in-up">
            <div className="relative z-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-5">
              <div>
                ...
                <p className="text-[44px] font-extrabold text-white tracking-tight leading-none tabular-nums animate-count-up font-heading">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <section>
              <div className="flex items-center justify-between mb-3">
                <h2 className="text-[13px] font-bold text-text-secondary uppercase tracking-wider font-heading">Portfolio Analysis</h2>
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-[13px] font-bold text-text-secondary uppercase tracking-wider font-heading">
        ...
        {bundles.length > 0 && (
          <section className="mt-8 animate-fade-in-up">
            <h2 className="text-[12px] font-bold text-text-secondary uppercase tracking-wider font-heading mb-4 flex items-center gap-2">
